define({ "api": [
  ...
  {
    "group": "goods",
    "name": "releaseSellProductInsteadCustomer",
    "type": "post",
    "url": "/goods/releaseSellProductInsteadCustomer",
    "title": "代客发布商品",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "description": "<p>预计交货时间</p>"
          },
          {
            "group": "Parameter",
            "type": "string",
            "optional": false,
            "field": "originPlacePrince",
            "description": "<p>产地省</p>"
          },
          {
            "group": "Parameter",
  ...
  {
    "type": "post",
    "url": "/userCenter/registerInsteadCustomer",
    "title": "代客注册",
    "name": "registerInsteadCustomer",
    "group": "userCenter",
    "parameter": {
      "fields": {
        "Parameter": [
